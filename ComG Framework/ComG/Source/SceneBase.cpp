...
void SceneBase::Init()
{
	...
	{
		int weaponOffset = 300;
		weaponmesh[i] = MeshBuilder::GenerateOBJ(ItemDataBase::getItemDB()->getItem(weaponOffset +i + 7)->getName(), ItemDataBase::getItemDB()->getItem(weaponOffset + i + 7)->getSourceLocation());
	}
	suntimer = 1;
	LoadSkybox();
