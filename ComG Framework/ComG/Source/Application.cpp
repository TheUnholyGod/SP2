...
void Application::Init()
{
	...
	Application::m_window = glfwCreateWindow(1080, 720, "FarmOut Goattageddon", NULL, NULL);
	//Application::m_window = glfwCreateWindow(1920, 1080, "Computer Graphics", glfwGetPrimaryMonitor(), NULL);
