...
void SceneGameOver::Init()
{
	...
	meshList[GEO_DEAD] = MeshBuilder::GenerateQuad("SplashScreen2", Color(0, 1, 0), 1.f);
	meshList[GEO_DEAD]->textureID = LoadTGA("Image//Game Over.tga");
...
void SceneGameOver::Render()
{
	...
	if (elapsed < 5)
	{
		RenderMeshOnScreen(meshList[GEO_DEAD], 40, 30, 80, 60);
	}
}
...
void SceneGameOver::DebugMode(double dt)
{
